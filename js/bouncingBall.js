...
//   let jump = Math.log(window / h) / Math.log(bounce);
//   if (h > 0 && bounce > 0 && bounce < 1 && window < h && jump === 1) {
//     return jump;
//   } else if (h > 0 && bounce > 0 && bounce < 1 && window < h) {
//     return Math.floor(jump) * 2 + 1;
//   } else return -1;
// }
...
// console.log(Math.log(1.5 / 3));
// console.log(Math.log(0.66));
// console.log(Math.log(1.5 / 3) / Math.log(0.66));
